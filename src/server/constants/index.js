...
export const CURA_ENGINE_MACOS = `${RESOURCES_DIR}/CuraEngine/4.1/macOS/CuraEngine`;
export const CURA_ENGINE_LINUX = `${RESOURCES_DIR}/CuraEngine/4.1/Linux/CuraEngine`;
export const CURA_ENGINE_WIN64 = `${RESOURCES_DIR}/CuraEngine/4.1/Windows-x64/CuraEngine.exe`;
